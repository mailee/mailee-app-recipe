...
default['mailerq']['rabbitmq']['retry'] = 'retries'
default['mailerq']['rabbitmq']['persistent'] = 1
...
#       postgresql://user:password@hostname/databasename
#
default['mailerq']['database'] = 'sqlite:///var/lib/mailerq/database.sqlite'
...
default['mailerq']['www-port'] = 8485
default['mailerq']['www-dir'] = '/usr/share/mailerq/www'
default['mailerq']['www-password'] = 'mailerq'
...
default['mailerq']['smtp-port'] = 2525
default['mailerq']['smtp-range'] = '192.168.0.0/16;127.0.0.1'
...
default['mailerq']['log-directory'] = '/var/log/mailerq'
default['mailerq']['log-history'] = 20
...
default['mailerq']['domain-maxmessages'] =  -1
default['mailerq']['domain-maxconnects'] =  -1
default['mailerq']['domain-maxconnections'] =  -1
#
...
#   Use -1 for unlimited.
#
default['mailerq']['ip-maxmessages'] =  -1
default['mailerq']['ip-maxconnects'] =  -1
default['mailerq']['ip-maxconnections'] =  2
...
default['mailerq']['connection-maxmessages'] = -1
default['mailerq']['connection-maxidle'] = 1000
default['mailerq']['connection-secure'] = 1
...
default['mailerq']['max-threads'] = 10
...
default['mailerq']['max-connections'] = 10000
...
default['mailerq']['max-messages'] = 100000
...
default['mailerq']['max-memory'] = '4GB'
...
default['mailerq']['max-deliver-time'] = 86400
...
default['mailerq']['max-attempts']  = 6
...
default['mailerq']['license']['path'] = '/etc/mailerq/license.txt'

default['mailerq']['license']['company'] = 'MailerQ Free License'
